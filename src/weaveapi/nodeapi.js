...
class NodeApi {
    ...
    publishDataset(session,
                   ...
                   scope, table, filter, format, price, token, publishOptions) {
        return this.client.publishDataset(session, did, name, description, license, metadata, weave, fullDescription, logo, category, scope, table, filter, format, price, token, publishOptions);
    }
    ...
    publishTask(session,
                did, name, description, license, metadata, weave, fullDescription, logo, category,
                task, price, token, publishOptions) {
        return this.client.publishTask(session, did, name, description, license, metadata, weave, fullDescription, logo, category, task, price, token, publishOptions);
    }
    ...
    history(session, scope, table, filter, historyOptions) {
        return this.client.read(session, scope, table, filter, historyOptions);
    }
