...
class ClientHttp {
    ...
    publishDataset(session, did, name, description, license, metadata, weave, fullDescription, logo, category, scope, table, filter, format, price, token, publishOptions) {
        const data = {
            "did": did,
            "name": name,
    ...
    publishTask(session, did, name, description, license, metadata, weave, fullDescription, logo, category, task, price, token, publishOptions) {
        const data = {
            "did": did,
            "name": name,
            "description": description,
